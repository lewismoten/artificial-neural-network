(() => {
  ...
  module.exports = (network, expectedOutput, learnRate, momentum) => {
    ...
    walker(hiddenLayer.previousWeights, (previousWeight, x, y) => {

      let delta = learnRate * hiddenGradients[y] * hiddenLayer.values[x];
      hiddenLayer.previousWeights[x][y] = delta;
      hiddenLayer.weights[x][y] += delta + momentum * previousWeight;
